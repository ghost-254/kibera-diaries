...
export const metadata: Metadata = createMetadata({
  title: "About Kibera Diaries",
  description:
    "Meet Kibera Diaries, a resident-led Nairobi tour team offering ethical Kibera walking tours, cultural experiences, community visits, and local storytelling.",
  path: "/about",
  keywords: [
    "about Kibera Diaries",
    "Kibera local guides",
    "Kibera resident led tours",
    "community tourism team Nairobi",
  ],
});
